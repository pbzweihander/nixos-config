{pkgs, ...}: {
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."Wayland"."InputMethod[$e]" = "/etc/profiles/per-user/pbzweihander/share/applications/org.fcitx.Fcitx5.desktop";
      "kwinrc"."Wayland"."InputMethodx5b$ex5d" = "/etc/profiles/per-user/pbzweihander/share/applications/org.fcitx.Fcitx5.desktop";
