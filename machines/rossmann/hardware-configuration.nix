...
# to /etc/nixos/configuration.nix instead.
{
  ...
  boot.kernelParams = ["resume-offset=21964032" "amdgpu.ppfeaturemask=0xfff7ffff"];
  ...
  boot.initrd.luks.devices."cryptroot".device = "/dev/disk/by-uuid/b7cc38fb-34e8-4a00-862f-593f51123c6e";
